...
# 预测值分布图
plt.figure(figsize=(10, 5))
plt.hist(y_pred_svr, bins=50, alpha=0.5, label='Predicted Price Change')
...
plt.plot(y_pred_svr, label='Predicted Price Change', linestyle='--')
plt.legend()
...
# 保存模型
joblib.dump(svr_model, '../xgb_model.pkl')